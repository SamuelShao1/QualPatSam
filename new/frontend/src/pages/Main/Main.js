...
import ProjectMain from '../Workspace/ProjectMain.js';
                ...
                <div className='h-full'>
                  ...
                  <div className='pb-[5vh] flex justify-center bg-overflow-hidden no-scroll text-[2vh] grid grid-cols-[repeat(auto-fill,minmax(20vh,25vh))] gap-[1vh] p-5 '>
                    {items.map(({ label, Icon, path }, idx) => (
                        <div
                          className='group relative h-[23vh] w-[23vh] cursor-pointer rounded-[2vh] bg-white border shadow-xl p-[2vh] duration-300 hover:bg-brand-100 hover:shadow-blue-100 '
                          key={idx}
